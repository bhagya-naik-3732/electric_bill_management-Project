...
$nameErr = $lastnameErr = $phoneErr = $addrErr = $emailErr = $passwordErr = $confpasswordErr = "";


$name = $lname = $email = $password = $confpassword = $address = "";
$flag=0;
...
if(isset($_POST["reg_submit"])) {
    $lastname = test_input($_POST["lname"]);    
        ...
        {
            require_once("Includes/config.php");
            $sql = "INSERT INTO user (`name`,`lname`,`email`,`phone`,`pass`,`address`)
                    VALUES('$name','$lname','$email','$contactNo','$password','$address')";
                    echo $sql;
...
<center>
    <div class="row form-group">
        ...
        <div class="col-md-12">
            <input type="lname" class="form-control" lastname="lname" id="lname" placeholder="last Name" required>
            <!-- <label><?php echo $nameErr;?></label> -->
        </div>
    </div>
